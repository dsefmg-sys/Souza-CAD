...
https://souzacad--souza-cad.us-east4.hosted.app/`;
  ...
  return (
    <div className="relative min-h-screen bg-slate-950 text-slate-100 font-sans selection:bg-emerald-500/30 selection:text-emerald-200">
      ...
      <header className="fixed top-2 sm:top-4 left-1/2 -translate-x-1/2 max-w-5xl w-[95%] sm:w-[92%] px-3 sm:px-5 py-2 flex items-center justify-between z-[60] bg-zinc-950/80 dark:bg-zinc-900/80 backdrop-blur-xl border border-white/10 shadow-2xl rounded-2xl pointer-events-auto select-none">
        <div className="flex items-center gap-2 group cursor-default">
          <div className="p-1 sm:p-1.5 rounded-xl bg-emerald-500/10 border border-emerald-500/30 group-hover:border-emerald-400/60 group-hover:bg-emerald-500/20 transition-all duration-300 shadow-md">
            <Compass className="size-4 sm:size-4.5 text-emerald-400 group-hover:rotate-45 transition-transform duration-500" />
          </div>
          <div className="text-left">
            <span className="text-sm sm:text-base font-black tracking-wide text-white">SOUZA <span className="text-emerald-400">CAD</span></span>
            <span className="hidden sm:block text-[8.5px] font-semibold uppercase tracking-wider text-emerald-400/85">Georreferenciamento</span>
          </div>
        </div>
        <div className="flex items-center gap-1.5 sm:gap-2 relative z-10">
          <button
            ...
            className="group px-2.5 sm:px-3.5 py-1 sm:py-1.5 rounded-full border border-white/10 bg-white/5 text-white/90 text-[11px] sm:text-xs font-semibold hover:bg-white/10 active:scale-95 transition-all cursor-pointer flex items-center gap-1 shadow-sm relative z-10 pointer-events-auto"
          >
          ...
          {onAbrirLogin && (
            <button
              ...
              className="px-2.5 sm:px-3.5 py-1 sm:py-1.5 rounded-full border border-emerald-500/40 bg-emerald-500/10 text-emerald-300 text-[11px] sm:text-xs font-bold hover:bg-emerald-500/20 hover:border-emerald-400 active:scale-95 transition-all cursor-pointer shadow-sm relative z-10 pointer-events-auto"
            >
              Login
            </button>
          )}
