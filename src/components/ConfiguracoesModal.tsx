...
export default function ConfiguracoesModal({ open, onOpenChange, onConfigChange, abaInicial }: Props) {
  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="max-w-5xl h-[88vh] max-h-[780px] flex flex-col bg-background/95 backdrop-blur-md shadow-2xl p-0 overflow-hidden rounded-xl text-foreground border border-border/50">
