...
export const MODELOS_PADRAO: ModelosDocs = {
  ...
  requerimentoResponsabilidade:
    ...
    'Por sua vez, os proprietários registrais, possuidores ou requerentes do imóvel declaram que a indicação física dos limites, marcos e confrontações fáticas em campo é de suas exclusivas responsabilidades, atestando que indicaram as divisas reais, pacíficas e consolidadas do imóvel no momento da medição.\n\n' +
    'Todos os signatários declaram, sob as penas da lei, que foram respeitados os direitos dos confrontantes e estão cientes de que respondem civil e criminalmente pela veracidade das informações, cada qual na medida de sua respectiva competência e atuação (o profissional pela exatidão das peças técnicas; e os proprietários/requerentes pela correta indicação física dos limites e veracidade dos acordos de confrontação).',
  requerimentoVenda:
